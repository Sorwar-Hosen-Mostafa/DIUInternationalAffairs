 ...
 */
public class ScholarshipProgram extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_scholarship_program, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)getActivity().findViewById(R.id.rec_list_scholarship);

        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));

        swipeRefreshLayout = (SwipeRefreshLayout) getActivity().findViewById(R.id.swipelayoutscholarship);



        parentLayout = getActivity().findViewById(R.id.swipelayoutscholarship);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i= 0; i<eventtablearray.length();i++) {
                        ...
                        if(eventtableobj.getString("Type").toString().equals("scholarship")){
